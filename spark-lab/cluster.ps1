...
if ( $args[0] -eq "deploy" ){
  ...
  docker run -d -p 8081:8081 -p 8080:8080 -p 8088:8088 -p 7077:7077 -p 9870:9870 -p 4040:4040 -p 8888:8888 -p 18080:18080 --network sparknet --name nodemaster -h nodemaster -v $PSScriptRoot/spark-apps:/opt/spark-apps -it hhmida/sparkbase
